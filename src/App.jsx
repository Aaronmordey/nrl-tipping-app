        ...
        <div>
          ...
          <div className="flex flex-col items-start gap-3">
            <div className="flex items-center gap-5">
              ...
              <div className="rounded-full bg-white/10 px-4 py-2 text-lg font-black text-slate-300">v</div>
              <TeamBadge team={game.away} logo={game.away_logo}/>
            </div>
            <div className="inline-flex items-center gap-2 rounded-2xl bg-white/10 px-4 py-2 text-sm font-bold text-slate-200">
